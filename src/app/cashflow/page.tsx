	...
	async function handleUpload(e: React.ChangeEvent<HTMLInputElement>) {
		...
		try {
			...
			if (!res.ok) {
				...
				setUploadMsg(
					`Berhasil mengimpor ${body.inserted ?? 0} baris data keuangan.`,
				);
				void fetchCashflow();
			}
		} catch {
				...
				>
					...
					<div style={{ display: "flex", gap: "0.5rem", alignItems: "center" }}>
						...
						<label
							style={{
								...
								color: uploading ? "var(--text-subtle)" : "var(--background)",
								borderRadius: "0.65rem",
								fontSize: "0.875rem",
								fontWeight: 600,
					...
					{uploadMsg && (
						<span
							style={{
								fontSize: "0.875rem",
								color: uploadMsg.startsWith("Berhasil")
									? "var(--positive)"
									: "var(--negative)",
							}}
						>
												...
												<td style={{ padding: "0.75rem 1rem" }}>
													<span
														style={{
															...
															fontWeight: 600,
															background:
																e.category === "income" ? "#f0fdf4" : "#fef2f2",
